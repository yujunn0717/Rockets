...
async function verifyOfflineCache(){
  try{
    const cache=await caches.open('rockets-lineup-manager-v1.2.1');
    const required=['./index.html','./styles-v121.css','./app-v121.js','./baseball-field.png','./rockets-watermark.png'];
